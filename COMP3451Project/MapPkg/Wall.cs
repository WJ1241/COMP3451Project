...
namespace COMP3451Project.PongPackage.EntityClasses
{
    ...
    public class Wall: Tiles, ICollidable
    {
        ...
        {
            //ASSIGNMENT: _texture is given the value of the tile + i, the '+ i' is to set the varient of tile as stated in the kernal's map 2d array
            _texture = Content.Load<Texture2D>("Tile" + i);
            //ASSIGNMENT: Rect is set to the value of pRect
            this.Rect = pRect;
        }
